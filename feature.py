...
def getAttributess(url):
    ...
    ssl=fe.SSLfinal_State(url)
    
    data=[[having_at_symbol,having_ip,
      prefix_suffix_separation,
     redirection_symbol,sub_domains,len_url, 
     age_domain,dns_record,domain_registration_length,
     http_tokens,statistical_report,
     tiny_url,web_traffic,ssl]]
